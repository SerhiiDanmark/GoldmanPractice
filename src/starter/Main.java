...
// B - Brick, GG - Gold, P - Player, G - Ground, E - Exit
    ...
    void moveUp () throws Exception{
        if (y - 1 >= 0 && data [y - 1][x].equals("G") || data [y - 1][x].equals("GG")) {
            data[y][x] = "G";
            y--;
            data[y][x] = "P";
        }
    ...
    void moveLeft () throws Exception {
        if (x - 1 >= 0 && data [y][x - 1].equals("G") || data [y][x - 1].equals("GG")) {
            data[y][x] = "G";
            x--;
            data[y][x] = "P";
        }
    ...
    void move(int direction) throws Exception{
        ...
        if (direction == 1) {
//            if (direction == 1 && data [y - 1][x].equals("G"))
            moveUp();
        } else if (direction == 2) {
//            if (direction == 2 && data [y + 1][x].equals("G"))
            moveDown();
        } else if (direction == 3) {
//            if (direction == 3 && data [y][x - 1].equals("G"))
            moveLeft();
        } else if (direction == 4) {
//            if (direction == 4 && data [y][x + 1].equals("G"))
            moveRight();
        }
